...
<head>
    ...
    <title>Rejected Requests - HOD Dashboard</title>
            ...
            <tbody>
                @forelse($requests as $request)
                    <tr>
                        ...
                        <td>
                            <span class="status-badge status-rejected" style="color: #000000;">
                                Rejected
                            </span>
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center py-4">No rejected requests found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
