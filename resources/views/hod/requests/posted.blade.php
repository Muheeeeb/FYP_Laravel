...
<head>
    ...
    <title>Posted Requests - HOD Dashboard</title>
    ...
    <style>
        ...
        * {
        ...
        /* Add these Bootstrap 4 pagination styles */
        .mt-4 {
            margin-top: 1.5rem;
        }
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="search-container">
            <form action="{{ route('hod.requests.posted') }}" method="GET" class="search-form">
