                ...
                <div class="card-body">
                    <div class="text-center mb-4">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode($admin->name) }}&background=random" 
                             class="rounded-circle img-fluid" style="width: 120px;" alt="Profile Picture">
                    </div>
                    <div class="mb-3">
                        <h6 class="card-subtitle mb-1 text-muted">Role</h6>
                        <p class="card-text">Administrator</p>
                    </div>
                    <div class="mb-3">
                        <h6 class="card-subtitle mb-1 text-muted">Member Since</h6>
                        <p class="card-text">{{ $admin->created_at->format('F d, Y') }}</p>
                    </div>
                </div>
            </div>
        </div>
